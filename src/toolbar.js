    ...
    fontSizeDiv.addEventListener('click', () => {
        ...
        if (!fontSizePopup) {
            ...
            const updateFontSizeDisplay = () => {
                ...
                // Set active/inactive state based on the font size
                if (fontSize === 16) {
                    // Font size is 16px, reset font-size-btn to inactive
                    this.setActiveButton('font-size-btn', false);
                } else {
                    // Font size has changed, set font-size-btn to active
                    this.setActiveButton('font-size-btn', true);
                }
            };
